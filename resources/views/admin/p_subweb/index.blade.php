...
@section('title', 'Pengajuan Sub Domain dan Web')
@section('isi')
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <a title="Setujui Pengajuan" class="btn <?php $btn = $psw->status == 'Selesai' ? 'btn-success' : 'btn-danger';echo $btn; ?>" href="<?= url('/admin/pengajuan_subweb_selesai/' . $psw->id_p_subweb) ?>">{{$psw->status}}</a> </td>
            </tr>
            @endforeach
        </tbody>
    </table>
